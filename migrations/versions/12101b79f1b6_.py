...
Revision ID: 12101b79f1b6
Revises: None
Create Date: 2019-10-08 08:17:42.299756

"""

# revision identifiers, used by Alembic.
revision = '12101b79f1b6'
down_revision = None
...
def upgrade():
    ...
    op.create_table('formular',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('jmeno', sa.String(), nullable=False),
    sa.Column('prijmeni', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_formular'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_formular_prijmeni', 'formular', ['prijmeni'], unique=False)
...
def downgrade():
    ...
    op.drop_table('users')
    op.drop_index('ix_formular_prijmeni', table_name='formular')
    op.drop_table('formular')
